...
#raw inputs
R_XYZ = REFERENCES_DIR / "4OTA" / "model0" /"model0_r.xyz"
INT_XYZ = REFERENCES_DIR / "4OTA" / "model0" /"model0_int.xyz"
P_XYZ = REFERENCES_DIR / "4OTA" / "model0" /"model0_p.xyz"
...
FIXED_ATOMS_1BASED = [47, 22, 17, 18, 40, 41]
