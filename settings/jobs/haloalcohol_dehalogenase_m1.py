...
JOB_ID = "haloalcohol_dehalogenase"
...
#raw inputs
R_XYZ =   REFERENCES_DIR / "model1" / "model1_r.xyz"
P_XYZ =   REFERENCES_DIR / "model1" / "model1_p.xyz"
...
FIXED_ATOMS_1BASED = [1, 2, 47, 49, 16, 24, 4, 8, 11, 45, 32, 39, 34]
