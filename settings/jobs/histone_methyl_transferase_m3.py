...
JOB_ID = "histone_methyl_transferase"
...
#raw inputs
R_XYZ =   REFERENCES_DIR / "model3" / "model3_r.xyz"
P_XYZ =   REFERENCES_DIR / "model3" / "model3_p.xyz"
...
FIXED_ATOMS_1BASED = [35, 23, 41, 20, 40, 81, 62, 6, 97]
