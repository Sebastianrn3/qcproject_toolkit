...
#raw inputs
R_XYZ =   REFERENCES_DIR / "model0" / "model0_r.xyz"
P_XYZ =   REFERENCES_DIR / "model0" / "model0_p.xyz"
TS_XYZ = REFERENCES_DIR / "model0" / "model0_ts.xyz"

# """
# C:\Users\User\AppData\Local\Programs\Python\Python313\python.exe C:\Users\User\Desktop\sv_qc_toolkit\data\tests.py
# Calculation started
# Atomai lygūs
# PROD-REAC -0.03827511932924993
# PROD-TS -0.019257079772448005
# TS-REAC 0.019257079772448005
# 0.0 -11.934000000000008 -24.018000000000015
#
